...
export class InitialMigration extends Migration {
  async up(): Promise<void> {
    ...
    this.addSql(
      'create table `article` (`id` int unsigned not null auto_increment primary key, `slug` varchar(255) not null, `title` varchar(255) not null, `description` varchar(255) not null, `body` varchar(255) not null, `created_at` datetime not null, `updated_at` datetime not null, `tag_list` text not null, `co_authors` text not null, `author_id` int unsigned not null, `favorites_count` int not null) default character set utf8mb4 engine = InnoDB;',
    );
